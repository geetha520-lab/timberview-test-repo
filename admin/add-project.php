...
// Default values (for repopulating form after error)
$title = "";
$content1 = "";
$location = "";
$client = "";
...
$contract_value = "";
$content2 = "";
$creation_date = date('Y-m-d'); // default today
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Image is optional, but if uploaded, handle it
    $image_path = null;
        ...
        if ($_FILES['image']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($ext, $allowed)) {
                ...
                if (move_uploaded_file($tmp_name, $target_path)) {
                    // Path to store in DB (relative from project root)
                    $image_path = "uploads/projects/" . $new_name;
                } else {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO projects (title, content1, location, client, plot_size, contract_value, content2, image_path, creation_date)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                // Clear form values
                $title = $content1 = $location = $client = $plot_size = $contract_value = $content2 = "";
...
<head>
    <meta charset="UTF-8">
    <title>Add Project - Kinstride Admin</title>
        ...
        <nav>
            ...
            <div class="menu-group">
                ...
                <div class="submenu open" id="servicesSubmenu">
                    <a href="add-project.php" class="menu-item active" style="background:#2563eb;">Add Project Details</a>
